...
JOptionPane.showMessageDialog(this,e.getMessage());}}
    ...
    private void initComponents() {
        ...
        jPanel1.add(l2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 20, 360, 70));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 130, 360, 350));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/wallpaper2you_54991.jpg"))); // NOI18N
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 490));
...
String type="PICK_UP";
String query1="Delete from mode;";
stmt1.executeUpdate(query1);
String query2="Insert into mode values('"+nm+"','"+type+"');";
